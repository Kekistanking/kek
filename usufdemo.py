...
vertical_hole_borders = pygame.sprite.Group()
horizontal_hole_borders = pygame.sprite.Group()
object_borders = pygame.sprite.Group()
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        movement_phase = (self.move_counter // 2) % 8
        if self.move_up:
        ...
        self.rect.x += self.change[0] * 3
        self.rect.y += self.change[1] * 3
        self.change = [0, 0]
